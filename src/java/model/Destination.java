...
public class Destination {
    ...
    public Destination(String id, String station_from, String station_to, String train_id, String time, String status, String fare, String last_activity, String last_modify_by, String total_seat, String seat_range, String type) {
        this.id = id;
    ...
    public String getSeat_range() {
        return seat_range;
    }

    public void setSeat_range(String seat_range) {
        this.seat_range = seat_range;
    }
